...
| 2026-09-18T04:00Z | ALIVE (container published; receipt PARTIAL_ALIVE, chicago honestly UNKNOWN) | main @ fcd6a068 (PR #341 merged) | container v26.9.17 PUBLISHED via dispatch run 35304615620 on fcd6a068: multi-arch manifest sha256:9c6a5c36..., cosign-signed; doctor 11/11 gates ALIVE incl. independent pull+run matching the digest; closure branch records receipts/release-v26.9.17-container.json + mfact.toml binding + lock [container] standing | closure PR merge; done |
